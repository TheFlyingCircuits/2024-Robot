...
public class ContinuousAimShooterAtSpeaker extends Command {

    Arm arm;
    Drivetrain drivetrain;

    /** Exact same as AimShooterAtSpeaker, but just never finishes until interrupted.
     *  This allows us to follow a path and aim as we go.
     */
    public ContinuousAimShooterAtSpeaker(Arm arm, Drivetrain drivetrain) {
        this.arm = arm;
