...
public final class Constants {
    ...
    public final static class DrivetrainConstants {
         ...
         */
        public static final double maxDesiredTeleopVelocityMetersPerSecond = 1; //CHANGE THIS MR. RICE!!!!!!!!!!!!!!!!!! 2.5 parade, 1 tailgate
         ...
         */
        public static final double maxDesiredTeleopAngularVelocityRadiansPerSecond = Units.rotationsToRadians(0.4);
